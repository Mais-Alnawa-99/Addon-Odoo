...
export class OwlSalesDashboard extends Component {
    ...
    getDates(){
        ...
        this.state.current_date = new Date(today.setDate(today.getDate() - this.state.period)).toISOString().split('T')[0];


        this.state.previous_date = new Date(today.setDate(today.getDate() - this.state.period * 2)).toISOString().split('T')[0];
    }
